  ...
  cargarDatos() {
    $.ajax({
      ...
      success: function (datos) {
        ...
        var stringDatos =
          "<ul><li>Número de elementos del XML: " + totalNodos + "</li>";
        ...
        stringDatos +=
          "<li>Temperatura mínima: " + temperaturaMin + " grados Celsius</li>";
        stringDatos +=
        ...
        stringDatos +=
          "<li>Dirección del viento: " + direccionViento + " grados</li>";
