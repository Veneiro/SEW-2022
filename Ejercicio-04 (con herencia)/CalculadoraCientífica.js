...
class SciCalculator extends BasicCalculator {
    constructor(operatorElements, keyPressedNumbersAllowed, keyPressedOperatorsAllowed) {
        super(operatorElements, '0', keyPressedNumbersAllowed, keyPressedOperatorsAllowed);
        this.displayValue = '0';
        this.operatorElements = operatorElements;
        this.waitingForOperator = true;
        this.value = null;
...
const scicalculator = new SciCalculator(operators, displayValue, operatorElements, keyPressedNumbersAllowed, keyPressedOperatorsAllowed);

// Keyup Event listeners
document.addEventListener('keyup', (event) => {
    scicalculator.onKeyUp(event);
});
